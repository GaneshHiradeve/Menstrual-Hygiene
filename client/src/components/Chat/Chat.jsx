					...
					<div class="position-relative">
						<div class="chat-messages p-4">
							...
							<div class="chat-message-right pb-4">
								<div>
									<img src="https://media.istockphoto.com/id/612520134/vector/girl-icon-cartoon-single-avatar-people-icon.jpg?s=612x612&w=0&k=20&c=DiBfKRoHjMpR1Ncm77ZxQLEGaq5JTD-0ddQTy0EkRT0=" class="rounded-circle mr-1" alt="Chris Wood" width="40" height="40"/>
							...
							<div class="chat-message-left pb-4">
								...
								<div class="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
									<div class="font-weight-bold mb-1">Expert 1</div>
